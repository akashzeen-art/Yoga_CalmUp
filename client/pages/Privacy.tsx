        ...
        <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md rounded-xl p-8 text-white">
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/90">
              ...
              <p>
                This Privacy Policy describes how Alphamovil Digital Solution LLP ("we", "us", or "our") collects, uses, discloses, and protects your personal information when you visit or use <strong>https://E-Yoga.com/</strong> (the "Site") or any of our services (collectively, the "Services").
              </p>
              <p>
              ...
              <p>
                E-Yoga is a Video-on-Demand (VOD) yoga subscription service. Access to content is granted upon successful subscription to one of the following plans:
              </p>
              <ul className="list-disc pl-6 space-y-1 mt-2">
              ...
              <p className="mt-3">
                Access to content is valid only for the duration of the active subscription period. Upon expiry, access will be revoked until the subscription is renewed. E-Yoga reserves the right to modify, update, or remove content from the platform at any time without prior notice.
              </p>
